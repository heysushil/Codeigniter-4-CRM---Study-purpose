...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Aug 2022 10:45:42 GMT -->
...
<head>
  ...
  <link rel="icon" href="<?= base_url(); ?>/public/crm_assets/images/logo/favicon-icon.png" type="image/x-icon">
  <link rel="shortcut icon" href="<?= base_url(); ?>public/crm_assets/images/logo/favicon-icon.png" type="image/x-icon">
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>/public/crm_assets/css/vendors/font-awesome.css">
  <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>/public/crm_assets/css/vendors/icofont.css">
  <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>/public/crm_assets/css/vendors/themify.css">
  <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>/public/crm_assets/css/vendors/flag-icon.css">
  <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>/public/crm_assets/css/vendors/feather-icon.css">
  <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>/public/crm_assets/css/vendors/scrollbar.css">
  <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>/public/crm_assets/css/vendors/animate.css">
  <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>/public/crm_assets/css/vendors/date-picker.css">
  <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>/public/crm_assets/css/vendors/photoswipe.css">
  <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>/public/crm_assets/css/vendors/bootstrap.css">
  <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>/public/crm_assets/css/style.css">
  <link id="color" rel="stylesheet" href="<?= base_url(); ?>/public/crm_assets/css/color-1.css" media="screen">
  <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>/public/crm_assets/css/responsive.css">
</head>
    ...
    <div class="page-header">
      <div class="header-wrapper row m-0">
        <div class="header-logo-wrapper col-auto p-0">
          <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="<?= base_url(); ?>/public/crm_assets/images/logo/logo.png" alt=""></a></div>
            ...
            <li class="cart-nav onhover-dropdown">
              ...
              <div class="cart-dropdown onhover-show-div">
                ...
                <ul class="custom-scrollbar">
                  <li>
                    <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="<?= base_url(); ?>/public/crm_assets/images/banner-1.jpg" alt="">
                  ...
                  <li>
                    <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="<?= base_url(); ?>/public/crm_assets/images/product-4.png" alt="">
                      <div class="media-body">
                  ...
                  <li>
                    <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="<?= base_url(); ?>/public/crm_assets/images/product-6.jpg" alt="">
                      <div class="media-body">
            ...
            <li class="onhover-dropdown">
              ...
              <div class="onhover-show-div notification-dropdown">
                ...
                <ul class="custom-scrollbar">
                  <li>
                    <div class="media">
                      <div class="notification-img bg-light-primary"><img src="<?= base_url(); ?>/public/crm_assets/images/avtar/man.png" alt=""></div>
                      <div class="media-body">
                  ...
                  <li>
                    <div class="media">
                      <div class="notification-img bg-light-secondary"><img src="<?= base_url(); ?>/public/crm_assets/images/avtar/teacher.png" alt=""></div>
                      <div class="media-body">
                  ...
                  <li>
                    <div class="media">
                      <div class="notification-img bg-light-info"><img src="<?= base_url(); ?>/public/crm_assets/images/avtar/teenager.png" alt=""></div>
                      <div class="media-body">
                  ...
                  <li>
                    <div class="media">
                      <div class="notification-img bg-light-success"><img src="<?= base_url(); ?>/public/crm_assets/images/avtar/chinese.png" alt=""></div>
                      <div class="media-body">
